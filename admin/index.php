...
<body class="bg-gradient-primary">
  ...
  <div class="container">
      ...
      <a href="/CP/erms/index.php" style="text-decoration-style: none"><button class="btn btn-primary btn-user btn-block" style="color: Yellow;">Home</button></a>
