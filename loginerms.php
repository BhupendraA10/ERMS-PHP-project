...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    ...
    <a href="index.php" style="text-decoration-style: none"><button class="btn btn-primary btn-user btn-block" style="color: Yellow;">Home</button></a>

    <!-- Outer Row -->
    <div class="row justify-content-center">

      <div class="col-xl-10 col-lg-12 col-md-9">
        <img src="1.png" alt="Bhupendra">
          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login-image">
                <img src="icon.png" alt="Bhupendra">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
